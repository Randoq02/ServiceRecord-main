...
const options = ['Employee#', 'GivenName', 'FirstName', 'MiddleName', 'School', 'Gmail'];
...
function getActionFromKey(key, menuOpen, activeFilteredIndex, max) {
...
MultiselectButtons.prototype.onInputKeyDown = function (event) {
    ...
    const action = getActionFromKey(key, this.open, activeFilteredIndex, max);
